# Graph Report - Nueva carpeta (5)  (2026-05-28)

## Corpus Check
- 11 files · ~33,781 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 516 nodes · 1205 edges · 30 communities (28 shown, 2 thin omitted)
...
Cohesion: 0.08
Nodes (87): appearsLoggedIn(), assertNotCancelled(), autoResolveManualLogin(), buildBrowserLaunchOptions(), cancelRun(), cleanupOldScreenshots(), clearConsultaStatusFilter(), clearManualWatcher() (+79 more)

### Community 1 - "Community 1"
Cohesion: 0.04
Nodes (45): action, afterCounts, allowedKeys, app, appendPersistentLog(), audit, beforeCounts, { chromium } (+37 more)

### Community 2 - "Community 2"
Cohesion: 0.06
Nodes (42): allData, appendPriorityCell(), bitacoraCaseKey(), bitacoraData, bitacoraHistoryCache, filteredData, findSinBitacoraRow(), formatClock() (+34 more)
...
Cohesion: 0.50
Nodes (5): formatCompactDate(), formatDisplayDate(), getCurrentMonthDateRange(), getDefaultDateRange(), parseConfiguredDate()

### Community 7 - "Community 7"
Cohesion: 0.18
Nodes (16): clearElement(), collapseBitacoraDuplicates(), fmtDate(), maybePlayAlertSound(), parseDateInputValue(), renderBitacora(), renderBitacoraAlerts(), renderChanges() (+8 more)

### Community 8 - "Community 8"
Cohesion: 0.11
Nodes (19): compareRows(), isLocalHost(), parseDateForSort(), parseSiniestrosExcel(), sortRows(), validateConfig(), writeJson(), assert (+11 more)
...
Cohesion: 0.13
Nodes (19): buildAuditMeta(), buildAuditMetaFromRequest(), buildGetPendientesUrl(), entries, excelValueToText(), inferDirectQueryParams(), inferDirectQueryParamsFromIframe(), isLoggedInUrl() (+11 more)
...
Cohesion: 0.13
Nodes (20): applyFilters(), applyTvConfig(), closeDetail(), getOperationalSummary(), getTotalPages(), renderOperationalSummary(), renderTablePage(), renderTvAlerts() (+12 more)

### Community 13 - "Community 13"
Cohesion: 0.23
Nodes (13): bitacoraMonitorKeySets(), buildMonitorIndexes(), findMonitorMatch(), getReferenceMonth(), isTerminada(), makeKey(), mergeCurrentMonthWithOpenOlderRows(), normalizePolicyKey() (+5 more)
...
Cohesion: 0.67
Nodes (3): extractItems(), previewToken(), waitForCapturedRows()
...
Cohesion: 0.47
Nodes (6): buildBrowserContextPayload(), buildBrowserPayload(), buildHealthPayload(), publicSchedulerInfo(), publicSessionInfo(), sanitizeUrlForClient()
